...
namespace EmployeeManagementWeb.Controllers
{
	public class EmployeeController : Controller
	{
		...
		public async Task<IActionResult> Index()
		{
			...
			// Hata durumu için uygun işlem yapılabilir
			return View("Error");
		}

		// Personel ekleme metodu (Get)
		public IActionResult Create()
		{
			return View();
		}

		// Personel ekleme metodu (Post)
		[HttpPost]
		...
		// Personel güncelleme metodu (Get)
		...
		// Personel güncelleme metodu (Post)
		[HttpPost]
